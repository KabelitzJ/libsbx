...
static auto show_gpu_memory_statistics() -> void {
...
static auto show_cpu_memory_statistics() -> void {
...
static auto show_memory_statistics() -> void {
  if (ImGui::Begin("Memory Statistics")) {
    show_gpu_memory_statistics();
  
    if constexpr (memory::is_memory_tracking_enabled_v) {
      show_cpu_memory_statistics();
    }
  }
