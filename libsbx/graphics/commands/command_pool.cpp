...
: _queue_type{queue_type} {
  ...
  validate(vkCreateCommandPool(logical_device, &command_pool_create_info, nullptr, &_handle), "vkCreateCommandPool");

  logical_device.set_debug_name(_handle, "Command Pool");
}
