...
/**
 * @brief The engine-wide `VkPipelineCache`, seeded from (and persisted back to) the active project's `pipeline_cache.bin` on disk.
 *
 * Built eagerly, at construction: a project is guaranteed active by then, per @ref core::engine_config::project.
 */
