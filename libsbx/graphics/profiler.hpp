...
#define SBX_PROFILE_GPU_CONTEXT_CREATE(type, name, physical_device, logical_device) \
  sbx::graphics::detail::register_gpu_context(type, name, physical_device, logical_device)
...
#define SBX_PROFILE_GPU_CONTEXT_CREATE(type, name, physical_device, logical_device) static_cast<void>(0)
