...
#ifndef LIBSBX_MODELS_STATIC_MESH_DEPTHPRE_SUBRENDERER_HPP_
#define LIBSBX_MODELS_STATIC_MESH_DEPTHPRE_SUBRENDERER_HPP_
...
class static_mesh_depthpre_subrenderer final : public graphics::subrenderer {
...
public:
  ...
  static_mesh_depthpre_subrenderer(const std::vector<graphics::attachment_description>& attachments, const std::filesystem::path& base_pipeline = default_pipeline_path);

  ~static_mesh_depthpre_subrenderer() override;
...
private:
  ...
  inline static const auto _entry_points = std::array<std::string, 2u>{
    "depth_prepass_opaque_main",  // alpha_mode::opaque
    "depth_prepass_mask_main",    // alpha_mode::mask
  };
...
#endif // LIBSBX_MODELS_STATIC_MESH_DEPTHPRE_SUBRENDERER_HPP_
