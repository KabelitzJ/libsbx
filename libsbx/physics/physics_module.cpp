...
auto physics_module::update() -> void {
...
auto physics_module::_integrate_velocities(std::float_t dt) -> void {
  // SBX_PROFILE_SCOPE("physics_module::_integrate_velocities");
...
auto physics_module::_integrate_positions(std::float_t dt) -> void {
  // SBX_PROFILE_SCOPE("physics_module::_integrate_positions");
...
auto physics_module::_collision_broad_phase() -> std::vector<collision_pair_type> {
  // SBX_PROFILE_SCOPE("physics_module::_collision_broad_phase");
...
auto physics_module::_collision_narrow_phase(const std::vector<collision_pair_type>& pairs) -> std::vector<collision> {
  // SBX_PROFILE_SCOPE("physics_module::_collision_narrow_phase");
...
auto physics_module::_resolve_collisions(const std::vector<collision>& collisions, std::float_t dt) -> void {
...
auto physics_module::_update_character_controllers() -> void {
...
auto physics_module::_update_cache(const std::vector<solver_contact>& solver_contacts) -> void {
...
auto physics_module::_positional_correction(const std::vector<collision>& collisions) -> void {
  // SBX_PROFILE_SCOPE("physics_module::_positional_correction");
