 ...
 * transparent_pass's shared fragment shader (shaders/pbr/geometry.slang) then looks up only its
 * own fragment's cluster instead of looping every light in the scene.
 *
