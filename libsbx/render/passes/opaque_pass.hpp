...
private:
  ...
  /** @brief This pass's own entry points/pipeline state for render::resolve_custom_pipeline. Passed to submit_draw_commands_indirect as its custom_pipeline_resolver. */
   ...
   * (_resolve_custom_pipeline has no polygon_mode parameter) -- not needed by anything
