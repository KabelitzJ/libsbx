...
// auto _emit_optional_image(YAML::Emitter& emitter, const char* key, const graphics::image2d_handle& image) -> void {
...
// auto _read_optional_image(const YAML::Node& node, const char* key, graphics::image2d_handle& image) -> void {
