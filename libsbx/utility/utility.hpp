 ...
 *
 * @brief General-purpose utilities for libsbx: hashing, string handling, compression, timing, and type introspection.
 *
 * @defgroup libsbx-utility Utility
 * @brief General-purpose utilities for libsbx.
 */
